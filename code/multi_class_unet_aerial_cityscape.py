...
for directory_path in glob.glob("../data/Master/train/AR1/S512x512/src/"):
...
train_masks = [] 
for directory_path in glob.glob("../data/Master/train/AR1/S512x512/gt/"):
...
#model.save('test_with_weights.hdf5')
